...
### ➡️ Rota de Usuarios | User Routes
    ...
    http://localhost:8080/usuarios/id_usuario - Rota PUT - Altera ficha de usuário na tabela de usuários
    http://localhost:8080/usuarios/id_usuario - Rota DELETE - Apaga um registro na tabela de usuários
